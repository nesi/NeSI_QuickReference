...
% additional packages
\usepackage{times}
\usepackage{amsmath, amsthm, amssymb, soul, color, multicol, type1cm, verbatim, latexsym, float, dsfont, listings,alltt,tabularx}
\usepackage{exscale}
%\boldmath
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{column}{.54\linewidth}
      ...
      \begin{tabular}{|c|c|c|c|}
      \hline 
      \textbf{Language} & \textbf{Intel} & \textbf{GNU} & \textbf{PGI} \\ 
      \hline 
...
%    \begin{column}{.38\linewidth}
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      \begin{block}{SSH Access : Login Node}
...
%  \end{columns}
    ...
    \begin{column}{.48\linewidth}
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      \begin{block}{Bash Shortcuts}
      \begin{itemize}
         \item Ctrl+c - halts the current command.
         \item Ctrl+z - stops the current command.
         \item Ctrl+d - log out of current session.
         \item Ctrl+k - Delete from the cursor to the end of the line.
         \item Ctrl+w - Delete from the cursor to the start of the word.
         \item Ctrl+u - Delete from the cursor to the beginning of the line.
         \item Ctrl+r - reverse search to bash history.
         \item !! - repeats the last command.
        \end{itemize}
      \end{block}
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
